...
my_bank2 = BankAccount.new
my_bank3 = BankAccount.new
my_bank4 = BankAccount.new
puts my_bank.account_number
puts my_bank.get_checking_balance
puts my_bank.get_saving_balance
puts my_bank.withdraw_checking(300)
puts my_bank.withdraw_saving(300).withdraw_checking(2)
puts my_bank.get_saving_balance
puts my_bank.get_checking_balance
puts my_bank.get_total_balance
BankAccount.display_num_of_accounts
